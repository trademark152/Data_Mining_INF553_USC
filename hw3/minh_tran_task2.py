...
"""
To run code: 
spark-submit minh_tran_task2.py Data/yelp_train.csv Data/yelp_val.csv 1 Minh_Tran_ModelBasedCF.txt
spark-submit minh_tran_task2.py Data/yelp_train.csv Data/yelp_val.csv 2 Minh_Tran_UserBasedCF.txt
spark-submit minh_tran_task2.py Data/yelp_train.csv Data/yelp_val.csv 3 Minh_Tran_ItemBasedCF.txt
"""
import sys
...
if __name__ == "__main__":
    if len(sys.argv)!=5:
        print("This function needs 4 input arguments <train_file_name> <test_file_name> <caseID> <outputFilePath>")
        exit(-1)
    ...
    # USER-BASED CF: to rate a business, gather similar users based on how they rate business; then evaluate other users how they rate this business and deduce
        ...
        # print("validation: ", validation.collect())
    ...
    # ITEM-BASED CF: to rate a business, gather similar businesses based on how they are rated by users; then evaluate other businesses' ratings how they rate this business and deduce
        ...
        print("Please provide a valid case number 1, 2 or 3")
